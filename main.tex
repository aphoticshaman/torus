...
\toprule
\textbf{Resolution} & \textbf{2\,m} & \textbf{5\,m} & \textbf{8\,m} & \textbf{12\,m} & \textbf{15\,m} & \textbf{20\,m} \\
\midrule
...
\textbf{The determining factor is apparent angular size.} The phase transition occurs between $\Gamma = 0.100$ (preserved) and $\Gamma = 0.075$ (lost), corresponding to a hole apparent half-angle of approximately $5$--$6°$. This parameterization is dimensionless and generalizes beyond this specific torus.
...
\begin{enumerate}[leftmargin=*]
    ...
    \item Ground truth: \texttt{cargo run --release -- --resolution 128 --photons 1000000 --topology --out .}
    \item Full experiment: \texttt{cargo run --release -- --resolution 128 --photons 1000000 --experiment --out .}
\end{enumerate}
...
\subsection{Boundary Operators over $\mathbb{Z}_2$}
